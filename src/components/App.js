        ...
        <div className="container-fluid p-0">
          ...
          <section className="resume-section p-3 p-lg-5 d-flex flex-column"
            ...
            <div className="my-auto">
              ...
              <div className="resume-item d-flex flex-column flex-md-row mb-5">
                ...
                <div className="resume-date text-md-right">
                  <span
                    className="text-primary">December 2011 - March 2013</span>
                </div>
              </div>
              ...
              <div className="resume-item d-flex flex-column flex-md-row mb-5">
                <div className="resume-content mr-auto">
                  ...
                  <div className="subheading mb-3">Shout! Media Productions
                  </div>
                ...
                <div className="resume-date text-md-right">
                  <span
                    className="text-primary">July 2010 - December 2011</span>
                </div>
              </div>
              ...
              <div className="resume-item d-flex flex-column flex-md-row">
                ...
                <div className="resume-date text-md-right">
                  <span
                    className="text-primary">September 2008 - June 2010</span>
                </div>
              </div>
          ...
          <section className="resume-section p-3 p-lg-5 d-flex flex-column"
            ...
            <div className="my-auto">
              ...
              <div className="subheading mb-3">Programming
                Languages &amp; Tools
              </div>
